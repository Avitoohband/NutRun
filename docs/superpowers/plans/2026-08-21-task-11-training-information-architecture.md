...
- [ ] **Step 1: Write failing mode and compact-layout tests**
...
- [ ] **Step 3: Implement saveable mode and compact day rows**
...
- [ ] **Step 3: Implement full-height assignment content**
...
- [ ] **Step 1: Write failing duplication and editor tests**
...
- [ ] **Step 2: Implement duplication atomically**
...
- [ ] **Step 3: Convert the editor to full screen**
...
- [ ] **Step 4: Remove unreachable legacy planner code**
...
- [ ] **Step 5: Run full validation and update handover**
